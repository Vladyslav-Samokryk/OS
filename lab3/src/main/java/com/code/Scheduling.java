package com.code;// This file contains the main() function for the Scheduling
    ...
    try {   
      ...
      while ((line = in.readLine()) != null) {
        ...
        if (line.startsWith("process")) {
          ...
          int tickets = Common.s2i(st.nextToken());
          X = Common.R1();
          while (X == -1.0) {
            X = Common.R1();
          }
  ...
  private static void debug() {
    ...
    for (i = 0; i < size; i++) {
      ...
      System.out.println("process " + i
              + " " + process.cputime + " " + process.ioblocking + " " + process.cpudone + " " + process.numblocked);
    }
